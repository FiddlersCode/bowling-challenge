...
``` 
As a player, so that I can play a bowling game, I would like to roll a ball to knock some pins down.

As a player, so that I can play a frame, I would like to keep track of my score.
```
